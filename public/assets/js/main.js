...
(function ($) {
  ...
  var _Swiper, _Swiper4, _Swiper5, _Swiper6, _Swiper7;
  ...
  var MOBILE_MENU_SIZE = 991;
  var rotatedCategories = $(window).width() <= MOBILE_MENU_SIZE;
  $(".categories-menu-header").on('click', function () {
    rotatedCategories = showHideLeftMenu(this, rotatedCategories);
  });
  var rotatedFilter = false;
  $(".color-menu-header").on('click', function () {
    rotatedFilter = showHideLeftMenu(this, rotatedFilter);
  });

  function showHideLeftMenu(clickEl, rotated) {
    var $clickEl = $(clickEl);
    $clickEl.next().slideToggle();
  ...
  var $offCanvasNav = $('.mobile-menu, .category-menu'),
      $offCanvasNavSubMenu = $offCanvasNav.find('.dropdown'); //Close Off Canvas Sub Menu if not active

  $.each($offCanvasNavSubMenu, function (index, value) {
    var $value = $(value);

    if (!$value.parent().hasClass('active') || $value.find('a.active').length === 0) {
      $value.slideUp();
    }
  ...
  var swiper = new Swiper('.hero-slider.swiper-container', (_Swiper = {
    loop: true,
    speed: 1150,
    spaceBetween: 30,
    slidesPerView: 1,
  ...
  var productCarousel = new Swiper('.product-list-carousel .swiper-container', _defineProperty({
    loop: true,
    slidesPerView: 1,
    spaceBetween: 0,
    pagination: false,
  ...
  var productCarousel = new Swiper('.product-list-carousel-2 .swiper-container', _defineProperty({
    loop: true,
    slidesPerView: 1,
    spaceBetween: 0,
    pagination: false,
  ...
  var productCarousel = new Swiper('.product-list-carousel-3 .swiper-container', (_Swiper4 = {
    loop: true,
    slidesPerView: 3,
    spaceBetween: 20,
    pagination: true,
  ...
  var swiper = new Swiper('.latest-blog-carousel .swiper-container', (_Swiper5 = {
    loop: true,
    slidesPerView: 3,
    spaceBetween: 20,
    pagination: true,
  ...
  var brandCarousel = new Swiper('.brand-logo-carousel .swiper-container', (_Swiper6 = {
    loop: true,
    speed: 750,
    spaceBetween: 30,
    slidesPerView: 5,
  ...
  }), _defineProperty(_Swiper6, "pagination", {
  ...
  var brandCarousel = new Swiper('.product-banner-carousel .swiper-container', (_Swiper7 = {
    loop: true,
    speed: 750,
    spaceBetween: 20,
    slidesPerView: 5,
  ...
  var productCarousel = new Swiper('.modal-product-carousel .swiper-container', _defineProperty({
    loop: true,
    slidesPerView: 1,
    spaceBetween: 0,
    pagination: false,
